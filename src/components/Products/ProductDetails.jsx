...
const ProductDetails = () => {
    ...
    return (
        <>
            <Banner />
            <div className="container mx-auto px-4 py-8 absolute top-60">
                <div className="bg-white rounded-lg shadow-md p-6">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-2">
                                <span className={`px-3 py-1 rounded text-sm ${availability ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
